...
ventana_principal.geometry("250x320")  # Ajustar tamaño de la ventana principal
...
style.configure('TButton',
    padding=6,
    relief="flat",
    background="#C63C51",  # Borde botton
    foreground="#8C3061",
    font=('Segoe UI', 12))
style.map('TButton',
    background=[('active', '#D95F59')],
    foreground=[('active', '#8C3061')])
...
# imagen = tk.PhotoImage(file=os.path.join('_internal', 'Imagenes', 'logo.png')).subsample(4,4)
# icono = tk.Label(image=imagen)
enlace = tk.Label(text="By Sammael", fg="#C63C51")
enlace.bind("<Button-1>", lambda e:abrir_url("https://www.pentestercr.com/")) 
# icono.pack(pady=0.5)
